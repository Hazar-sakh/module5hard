...
class Video:
    """
    Создаем класс Video и определяем его атрибуты, спец.методы и функции класса:
    __init__ - конструктор класса, вызывается при создании
    __eq__ - для сравнения названий видео
    __str__ - для вывода названия видео в виде строки
    dur - для возвращения значения длины видео
